...
const About = () => {
  return (
    <div id='about' className='font-rubik w-screen min-h-screen my-[75px] px-[50px] md:px-[122px] flex items-center justify-center bg-white'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[100px] justify-start items-center'>
            <img alt='/' src={Logo} className='' />
            <div className='text-[14px] md:text-[16px] text-[#4F5665] font-normal leading-6'>
                <h1 className='w-full md:w-[428px]'>
                ...
                <h1 className='w-full md:w-[428px] mt-5'>
